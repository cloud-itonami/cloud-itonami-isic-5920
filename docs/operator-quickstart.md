# Operator Quickstart — Sound Recording and Music Publishing Activities

Shortest path from clone to a verified local dry-run for **ISIC 5920** (`cloud-itonami-isic-5920`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-5920.git
cd cloud-itonami-isic-5920
```
...
- Blueprint governor key: `music-ops-governor`
- Likely source path: `musicops.governor.cljc`
